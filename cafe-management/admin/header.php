...
<head>
    ...
    <meta name="description" content="BlueCity Cafe is a beautiful area to enjoy coffee, shakes, and mocktails at our charming cafe. Savor every sip and treat your taste buds to a memorable experience.">
    <meta name="keywords" content="coffee shops,coffee shops near me, espresso near me, best coffee near me, coffee bar">
    <meta name="author" content="LIPS">
    
   
    <meta name="robots" content="follow">
    <title>Cafe Management Management</title>
        ...
        <div class="container ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-light fw-bolder px-1 active" aria-current="page"
                            href="../index.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light fw-bolder px-1" href="../index.php">About Us</a>
                    </li>
                    <li class="nav-item">
                        <?php if (isset($_SESSION['user_data']) || isset($_SESSION['admin_data'])) {
                            ?>
                            <a class="nav-link text-light fw-bolder px-1" href="../coffee.php">Products</a>
                        <?php } else { ?>
                            <a class="nav-link text-light fw-bolder px-1" href="../login.php">Products</a>
                        <?php } ?>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light fw-bolder px-1" href="../contact.php">Contact</a>
                    </li>
                    <li class="nav-item d-flex">
                        <?php if (isset($_SESSION['user_data'])) { ?>

                            <a class="nav-link px-1" href="./logout.php" data-bs-toggle="tooltip" data-bs-title="logout">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu text-center">
                                <li><a class="nav-link fw-bolder px-1" href="./login-details.php">login_details</a>
                                </li>

                                <li><a class="nav-link px-1 " href="./logout.php" data-bs-toggle="tooltip"
